...
public class AggregateDataNode extends BaseNode implements DataNode {
    ...
    //TODO (myCode)
    public Set<DataNode> getAggregatedNodes() {
    ...
    private <R> LinkedHashMultiset<R> mapAggregatedNodes(Function<DataNode, R> getName) {
        return LinkedHashMultiset.create(aggregatedNodes.stream()
