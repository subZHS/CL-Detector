...
import static de.tu_darmstadt.stg.mudetect.aug.builder.APIUsageExampleBuilder.buildAUGExample;
...
public class APIUsageExampleBuilderTest {
    ...
    public void addMethodCall() {
        APIUsageExample aug = buildAUGExample(SOME_LOCATION).withMethodCall(":id:", "O", "m()", 42).build();
    ...
    public void addVariable() {
        APIUsageExample aug = buildAUGExample(SOME_LOCATION).withVariable(":id:", "O", "o").build();
    ...
    @Test
    public void addEdge() {
        APIUsageExample aug = buildAUGExample(SOME_LOCATION)
    ...
    public void setsLocation() {
        APIUsageExample aug = buildAUGExample(SOME_LOCATION).build();
