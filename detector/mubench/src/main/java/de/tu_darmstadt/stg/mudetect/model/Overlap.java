...
public class Overlap {
    ...
    //TODO (myCode)
    public Set<Node> getRedundantNodes(){
        Set<Node> targetNodes = new HashSet<>(getTarget().vertexSet());
        targetNodes.removeAll(targetOverlap.vertexSet());
        return targetNodes;
    }

    public Set<Edge> getRedundantEdges() {
        Set<Edge> targetEdges = new HashSet<>(getTarget().edgeSet());
        targetEdges.removeAll(targetOverlap.edgeSet());
        return targetEdges;
    }
