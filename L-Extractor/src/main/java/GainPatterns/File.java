...
//       if (status == null) {
//           status = (this.path.indexOf('\u0000') < 0) ? java.io.File.PathStatus.CHECKED
//                   : java.io.File.PathStatus.INVALID;
//       }
//       return status == java.io.File.PathStatus.INVALID;
//   }
//
//   /**
...
//       private static final java.io.File tmpdir = new java.io.File(
...
//           = UNSAFE.objectFieldOffset(java.io.File.class, "path");
//   private static final long PREFIX_LENGTH_OFFSET
//           = UNSAFE.objectFieldOffset(java.io.File.class, "prefixLength");
//
